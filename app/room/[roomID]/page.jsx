        ...
        <div className={style.mainwrapper}>
            ...
            <div id="root" className={style.root}>
                ...
                {(isConnected === false) && <>
                    ...
                    <div className={style.heading}>Welcome to JoBro</div>
                    <div className={style.connect} onClick={initConnect}>Join room</div>
