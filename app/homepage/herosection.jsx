        ...
        <div className="flex py-[100px] pt-[150px]">
            <div className="w-[50%] flex flex-col justify-center relative left-[50px]">
                ...
                <div className="flex gap-2 mt-[10px]">
                    <button className="px-4 py-2 border-2 border-[#F67036] text-[#F67036] font-medium rounded-md">Aspiral GPT</button>
                    <button className="px-4 py-2 border-2 border-[#AB3BD2] text-[#5d276f] font-medium rounded-md">Aspiral GPT</button>
                ...
                <div class="w-[622px] h-[430px] flex-col justify-start items-start gap-[38px] inline-flex">
                    <div class="justify-start items-center gap-6 inline-flex">
                        ...
                        <div class="flex-col justify-start items-start gap-3 inline-flex">
                            <div class="text-center text-zinc-800 text-xl font-semibold font-['Inter'] leading-snug">Aspiral GPT</div>
                            <p class="w-[302px] text-neutral-600 text-base font-medium font-['Inter']">“Discover your career path with Aspiral GPT, your AI-powered career counselling ally, illuminating the next 7-10 years of your journey”<br /></p>
                        </div>
                    </div>
                    <div class="justify-start items-center gap-6 inline-flex">
                        <div class="flex-col justify-start items-start gap-3 inline-flex">
                            <p class="text-center text-zinc-800 text-xl font-semibold font-['Inter'] leading-snug">CourseNet AI</p>
                            <p class="w-[302px] text-neutral-600 text-base font-medium font-['Inter']">“Discover your career path with Aspiral GPT, your AI-powered career counselling ally, illuminating the next 7-10 years of your journey”<br /></p>
                        </div>
                        <div class="w-[296px] h-[196px] relative">
                            <img class="w-[295.79px] h-[196px] left-0 top-0 absolute rounded-lg" src="./pexels-ivan-samkov-4240507.png" />
                            <div class="w-[296px] h-[196px] left-0 top-0 absolute">
                                <div class="w-[296px] h-[196px] left-0 top-0 absolute bg-neutral-700 bg-opacity-50 rounded"></div>
                                <div class="w-[51.85px] h-12 left-[122.07px] top-[74px] absolute"></div>
                            </div>
