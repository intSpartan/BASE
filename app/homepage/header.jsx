            ...
            <div className="w-full fixed z-50 h-[72px] px-20 py-4 bg-white shadow flex-col justify-center items-start gap-2.5 inline-flex">
                <div className="justify-between items-start gap-[670px] inline-flex">
                    ...
                    <div className="justify-start ml-[100px] items-start gap-4 flex">
                        ...
                        <div className="w-[78px] p-2.5 bg-white rounded justify-center items-center gap-2.5 flex">
                            <div className="text-center text-neutral-400 text-sm font-medium font-['Inter']">Services</div>
                        </div>
                        <div className="w-[50px] p-2.5 bg-white rounded justify-center items-center gap-2.5 flex">
                            <div className="text-center text-neutral-400 text-sm font-medium font-['Inter']">Blog</div>
                        </div>
                        <div className="w-[75px] p-2.5 bg-white rounded justify-center items-center gap-2.5 flex">
