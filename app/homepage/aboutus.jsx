export default function Aboutus() {
    return (
        <div className="w-min-screen py-[100px] flex flex-col justify-center items-center">
            <div className="w-[1281px] h-[150px] justify-start items-center gap-[540px] inline-flex">
            ...
            <div className="w-[1280px] mt-[50px] h-[516px] justify-start items-start gap-6 inline-flex">
