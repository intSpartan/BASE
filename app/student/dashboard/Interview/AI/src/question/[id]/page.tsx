            ...
            <div className="flex-grow flex px-12">
                <div className="w-1/2 flex flex-col bg-neutral-100 p-6 rounded-2xl border border-neutral-500 mr-2">
                    <div className="flex items-center">
                        <div className="text-3xl font-bold text-neutral-700 mb-5">Problem: {((params.id ?? "") as string).split("-").map(word => word.at(0)?.toUpperCase() + word.substring(1, word.length)).join(" ")}</div>
