    ...
    const fetchInterviews = async () => {
      ...
      try {
        ...
        const interviewRes = await fetch(
          `/api/interview/applicant/${applicantData.applicants._id}`
        );
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your scheduled interviews and related documents
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
                    ...
                    <TableRow key={job._id}>
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          <Button
                            size="sm"
                            onClick={() => handleAttemptInterview(job._id)}
                          >
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => handleOpenDocument(job._id)}
                          >
