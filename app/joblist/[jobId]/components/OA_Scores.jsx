                    ...
                    <section className="mx-auto w-full max-w-7xl px-4 py-4 flex-col justify-between space-y-32">
                        <div>
                            <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
                                <div>
                                    <h2 className="text-2xl font-semibold">Online Assessments Scores</h2>
                                    <p className="mt-1 text-base text-gray-700">
                                        This is a list of scores of all the shortlisted candidates in Online Assessment
                                    </p>
                                </div>
                                <div>
